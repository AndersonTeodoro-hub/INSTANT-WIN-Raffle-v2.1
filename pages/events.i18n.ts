...
const en: EventsCopy = {
  ...
  create: {
    ...
    pausedBanner: 'The platform is paused right now. New campaigns cannot be created until it is unpaused.',
...
const pt: EventsCopy = {
  ...
  list: {
    metaTitle: 'Event Center — Instant Win',
    metaDescription: 'Giveaways ao vivo no GiveawayManagerV2, Arbitrum One. Participe por email e Telegram, ou ligue uma carteira.',
    eyebrow: 'Event Center',
    title: 'Giveaways, ao vivo na Arbitrum',
    ...
    createCta: 'Criar um giveaway',
    myEventsCta: 'Os meus giveaways',
    empty: 'Ainda não há giveaways. Seja o primeiro a criar um.',
  ...
  create: {
    metaTitle: 'Criar um giveaway — Instant Win',
    metaDescription: 'Crie um giveaway no GiveawayManagerV2: deposite um prémio ERC-20, ERC-721 ou ERC-1155 e compre slots de entrada.',
    title: 'Criar um giveaway',
    intro: 'Assina a criação e o depósito você mesmo, com o seu próprio gas. O prémio nunca passa pela plataforma.',
    connectPrompt: 'Ligue uma carteira para criar um giveaway.',
    pausedBanner: 'A plataforma está pausada neste momento. Não é possível criar novas campanhas até ser despausada.',
    ...
    submitCta: 'Criar giveaway',
    submitting: 'A criar…',
    success: 'Giveaway criado.',
    viewEvent: 'Ver evento',
  },
  dashboard: {
    metaTitle: 'Os meus giveaways — Instant Win',
    title: 'Os meus giveaways',
    intro: 'Cada campanha que criou, e o que precisa a seguir.',
    connectPrompt: 'Ligue uma carteira para ver os seus giveaways.',
    empty: 'Ainda não criou nenhum giveaway.',
...
const es: EventsCopy = {
  ...
  list: {
    metaTitle: 'Event Center — Instant Win',
    metaDescription: 'Giveaways en vivo en GiveawayManagerV2, Arbitrum One. Participa por email y Telegram, o conecta una wallet.',
    eyebrow: 'Event Center',
    title: 'Giveaways, en vivo en Arbitrum',
    ...
    createCta: 'Crear un giveaway',
    myEventsCta: 'Mis giveaways',
    empty: 'Todavía no hay giveaways. Sé el primero en crear uno.',
  ...
  create: {
    metaTitle: 'Crear un giveaway — Instant Win',
    metaDescription: 'Crea un giveaway en GiveawayManagerV2: deposita un premio ERC-20, ERC-721 o ERC-1155 y compra cupos de entrada.',
    title: 'Crear un giveaway',
    intro: 'Firmas la creación y el depósito tú mismo, con tu propio gas. El premio nunca pasa por la plataforma.',
    connectPrompt: 'Conecta una wallet para crear un giveaway.',
    pausedBanner: 'La plataforma está pausada en este momento. No se pueden crear campañas nuevas hasta que se reanude.',
    ...
    submitCta: 'Crear giveaway',
    submitting: 'Creando…',
    success: 'Giveaway creado.',
    viewEvent: 'Ver evento',
  },
  dashboard: {
    metaTitle: 'Mis giveaways — Instant Win',
    title: 'Mis giveaways',
    intro: 'Cada campaña que creaste, y qué necesita a continuación.',
    connectPrompt: 'Conecta una wallet para ver tus giveaways.',
    empty: 'Todavía no has creado ningún giveaway.',
